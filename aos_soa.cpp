...
private:
    T<__Type_Helpers::plain_wrapper, 1>* source;
...
struct Type_Ref : public T<__Type_Helpers::ref_wrapper, 1>
{
    ...
    auto get_ref(size_t = 0) const { return __Type_Helpers::SOA_convert<const T<__Type_Helpers::ref_wrapper, 1>, T<__Type_Helpers::constref_wrapper, 1>>(*this); };
...
struct Type_Plain : public T<__Type_Helpers::plain_wrapper, 1>
{
    ...
    auto get_ref(size_t = 0) { return __Type_Helpers::SOA_convert<T<__Type_Helpers::plain_wrapper, 1>, T<__Type_Helpers::ref_wrapper, 1>>(*this); };
    auto get_ref(size_t = 0) const { return __Type_Helpers::SOA_convert<const T<__Type_Helpers::plain_wrapper, 1>, T<__Type_Helpers::constref_wrapper, 1>>(*this); };
...
struct Type_SOA : public T<__Type_Helpers::soa_wrapper, N>
{
    ...
    auto get_ref(size_t idx) { return __Type_Helpers::SOA_convert<T<__Type_Helpers::soa_wrapper, 1>, T<__Type_Helpers::ref_wrapper, 1>>(*this, idx); };
    auto get_ref(size_t idx) const { return __Type_Helpers::SOA_convert<const T<__Type_Helpers::soa_wrapper, 1>, T<__Type_Helpers::constref_wrapper, 1>>(*this, idx); };
    auto get_copy(size_t idx) const { return __Type_Helpers::SOA_convert<const T<__Type_Helpers::soa_wrapper, 1>, T<__Type_Helpers::plain_wrapper, 1>>(*this, idx); };
...
struct Type_AOS : public T<__Type_Helpers::array_helper<T>::template array_type_wrapper, N>
{
    ...
    auto get_ref(size_t idx) { return __Type_Helpers::SOA_convert<decltype(values[idx]), T<__Type_Helpers::ref_wrapper, 1>>(values[idx]); };
    auto get_ref(size_t idx) const { return __Type_Helpers::SOA_convert<decltype(values[idx]), T<__Type_Helpers::constref_wrapper, 1>>(values[idx]); };
    auto get_copy(size_t idx) const { return __Type_Helpers::SOA_convert<decltype(values[idx]), T<__Type_Helpers::plain_wrapper, 1>>(values[idx]); };

    template <typename S>
    auto get_array_ptr(S T<__Type_Helpers::plain_wrapper, 1>::*p) {
        return __Type_Helpers::AOS_arrayview<T, N, S>(values, p);
    }

private:
    T<__Type_Helpers::plain_wrapper, 1> values[N];

    T<__Type_Helpers::array_helper<T>::template array_type_wrapper, N> get_arrays() {
